            ...
            <div className="py-[80px] bg-[url('https://i.ibb.co/TM2LyDrs/br-grad.png')] bg-no-repeat bg-cover">
                <div className="max-w-[1410px] w-full mx-auto">
                    <div className="flex flex-col lg:flex-row gap-[40px]">
                        <div className="w-[550px] lg:w-[781px] flex flex-col gap-[34px]">
                            <div className="w-[163px] h-[44px]">
                                <img src="https://i.ibb.co/fw4c5ft/Group-35.png" className="w-full h-full" alt="" />
                            </div>
                            <div className="flex flex-col gap-[18px]">
                                <h3 className="text-[65px] leading-[75px] lg:text-[78px] font-bold lg:leading-[113px] text-black">Interested in <span className="bg-black px-[12px] rounded-lg py-[8px] text-white">work</span> together?</h3>
